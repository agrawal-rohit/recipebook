...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 h-full max-h-100 min-w-0 w-full max-w-lg rounded-lg border font-sans shadow-none",
        className,
      )}
    >
      <div className="flex flex-col gap-y-2 border-b border-inherit p-4">
      ...
      <pre className="min-w-0 overflow-x-auto p-4">
