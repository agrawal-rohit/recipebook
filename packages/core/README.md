...
This package powers the [`recipebook`](https://www.npmjs.com/package/recipebook) CLI, which points at a registry source via `--registry`, `RECIPEBOOK_REGISTRY`, or `recipebook configure set`.
