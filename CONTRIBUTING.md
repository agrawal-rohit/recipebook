...
Thanks for your interest in contributing to `recipebook`! This guide will help you get started with the development process, from setting up your environment to submitting changes.
...
- Search existing [GitHub Discussions](https://github.com/agrawal-rohit/recipebook/discussions) first
- Open a new discussion for questions and proposals
- Create a [GitHub Issue](https://github.com/agrawal-rohit/recipebook/issues) for bug reports
...
4. Test the CLI package locally: `pnpm --filter recipebook pack`
...
`recipebook` consumes code registries — JSON indexes of reusable setup items _(starter templates, UI components, configurations, agent instructions)_. Registries are authored and hosted outside this repository. A registry source is an HTTPS URL or a local file path to a compiled index, and the CLI resolves it via `--registry`, the `RECIPEBOOK_REGISTRY` environment variable, or a saved source persisted with `recipebook configure set`. No registry ships in the box.

## Security

- **Do not** report security vulnerabilities in public issues
- Use GitHub's [private vulnerability reporting](https://github.com/agrawal-rohit/recipebook/security/advisories/new)
